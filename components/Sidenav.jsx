...
//               onClick={showNav}
//               href={link.link}
//               className="w-[75%] flex items-center justify-center rounded-full shadow-lg bg-gray-200 shadow-gray-400 m-2 p-4 text-gray-500 text-lg font-semibold cursor-pointer hover:scale-110 transition-all duration-200"
//             >
//               {link.name}
//             </Link>
//           ))}
